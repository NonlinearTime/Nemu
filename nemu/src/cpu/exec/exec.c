...
opcode_entry opcode_table [512] = {
  ...
  /* 0x50 */	IDEX(r, push), IDEX(r, push), IDEX(r, push), IDEX(r, push), //enum { R_EAX, R_ECX, R_EDX, R_EBX, R_ESP, R_EBP, R_ESI, R_EDI };
  /* 0x54 */	IDEX(r, push), IDEX(r, push), IDEX(r, push), IDEX(r, push),
  /* 0x58 */	IDEX(r, pop), IDEX(r, pop), IDEX(r, pop), IDEX(r, pop),
  /* 0x5c */	IDEX(r, pop), IDEX(r, pop), IDEX(r, pop), IDEX(r, pop),
  /* 0x60 */	EX(push), EX(pop), EMPTY, EMPTY,
  ...
  /* 0x98 */	IDEX(A, cwtl), IDEX(A, cltd), EMPTY, EMPTY,
  ...
  /* 0xe0 */	EMPTY, EMPTY, EMPTY, IDEXW(jmp_call_I, jcc, 1),
  /* 0xe4 */	IDEXW(in_I2a, in, 1), IDEX(in_I2a, in), IDEXW(out_a2I, out, 1), IDEX(out_a2I, out),
  /* 0xe8 */	IDEX(jmp_call_I, call), IDEX(jmp_call_I, jmp), EMPTY, IDEXW(jmp_call_I, jmp, 1),
  ...
  /* 0x80 */	IDEX(jmp_call_I, jcc), IDEX(jmp_call_I, jcc), IDEX(jmp_call_I, jcc), IDEX(jmp_call_I, jcc),
  /* 0x84 */	IDEX(jmp_call_I, jcc), IDEX(jmp_call_I, jcc), IDEX(jmp_call_I, jcc), IDEX(jmp_call_I, jcc),
  /* 0x88 */	IDEX(jmp_call_I, jcc), IDEX(jmp_call_I, jcc), IDEX(jmp_call_I, jcc), IDEX(jmp_call_I, jcc),
  /* 0x8c */	IDEX(jmp_call_I, jcc), IDEX(jmp_call_I, jcc), IDEX(jmp_call_I, jcc), IDEX(jmp_call_I, jcc),
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEX(mov_RMb2R, mov), IDEX(mov_RMw2R, mov),
  /* 0xb8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xbc */	EMPTY, EMPTY, IDEX(mov_SRMb2R, mov), IDEX(mov_SRMw2R, mov),
