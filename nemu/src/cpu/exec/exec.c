...
opcode_entry opcode_table [512] = {
  ...
  /* 0xe8 */	IDEX(jmp_call_I, call), EMPTY, EMPTY, EMPTY,
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEX(Ib2r, mov), IDEX(Iw2r, mov),
...
void exec_wrapper(bool print_flag) {
  ...
  // }
#endif
  printf("\033[1;31;40m eip: 0x%x: %s\n\033[0m", ori_eip, decoding.assembly);// rtlreg_t eax, ecx, edx, ebx, esp, ebp, esi, edi;
